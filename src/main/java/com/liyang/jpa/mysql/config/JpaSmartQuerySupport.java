...
public class JpaSmartQuerySupport {
	...
	protected void register() throws Exception {
		...
		NamedParameterJdbcTemplate jdbc = ApplicationContextSupport.getBean(NamedParameterJdbcTemplate.class);
		if(jdbc==null){
			throw new StructureException("spring data jpa没有安装");
		}
		jdbcTemplate = jdbc;
	...
	private void _entityStructureCheckAndRegister(Class<?> entityClass, JpaRepository jpaRepository) {
		...
		nameToStructure.put(entityStructure.getName(), entityStructure);
