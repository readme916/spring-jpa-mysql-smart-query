...
public class Stopword {
	...
	final static HashSet<String> stopwordSet = new HashSet<>();
	final static String stopWords = "ADD ALL ALTER ANALYZE AND AS ASC ASENSITIVE BEFORE BETWEEN BIGINT BINARY BLOB BOTH BY CALL CASCADE CASE CHANGE CHAR CHARACTER CHECK COLLATE COLUMN"
	...
	static {
		...
		String[] splitWords = Stopword.stopWords.split("\\s");
